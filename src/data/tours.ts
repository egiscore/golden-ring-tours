...
export const tours: Record<string, Tour> = {
  ...
  'bus-tour': {
    id: 'bus-tour',
    title: 'Легендарная Русь — классический тур',
    description: 'Самый популярный маршрут по Золотому кольцу',
    fullDescription: 'Классический автобусный тур охватывает главные жемчужины Золотого кольца. За 2 дня вы посетите древние города — Переславль-Залесский, Ростов Великий, Ярославль и Кострому. Комфортабельный автобус, профессиональный гид и насыщенная программа позволят увидеть лучшие достопримечательности без забот о логистике.',
    price: 'от 10 390 ₽',
    duration: '2-5 дней',
    icon: 'Bus',
    ...
    program: [
      'День 1 (07:45): Встреча группы. Отправление из города. Переезд в Переславль-Залесский (140 км). Обзорная экскурсия — Спасо-Преображенский собор XII века, Горицкий монастырь, Плещеево озеро. Обед в кафе города. Переезд в Ростов Великий (60 км). Экскурсия по Ростовскому Кремлю — Успенский собор, звонница с знаменитыми ростовскими колоколами, переходы по крепостным стенам. Переезд в Ярославль (55 км). Размещение в гостинице 3★. Свободное время',
      'День 2: Завтрак в гостинице. Обзорная экскурсия по Ярославлю — исторический центр (объект ЮНЕСКО), набережная Волги, церковь Ильи Пророка XVII века с уникальными фресками, Спасо-Преображенский монастырь, где было найдено «Слово о полку Игореве». Переезд в Кострому (85 км). Обед. Экскурсия — Ипатьевский монастырь (колыбель династии Романовых), Троицкий собор, Музей деревянного зодчества под открытым небом. Отправление в обратный путь. Прибытие поздним вечером'
    ],
    included: [
    ...
    options: [
      { days: 2, price: 10390, description: 'Классический (Переславль + Ростов + Ярославль + Кострома)' },
      { days: 3, price: 15900, description: 'Расширенный + Суздаль' },
      { days: 4, price: 20500, description: 'Полный + Владимир + Сергиев Посад' },
      { days: 5, price: 25800, description: 'Максимальный со всеми городами' }
    ]
  },
  'cruise': {
    id: 'cruise',

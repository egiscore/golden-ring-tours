  ...
  'bus-tour': {
    ...
    options: [
      ...
      { 
        days: 3, 
        price: 15900, 
        description: 'Расширенный + Суздаль',
        cities: ['Переславль-Залесский', 'Ростов Великий', 'Ярославль', 'Кострома', 'Суздаль'],
        program: [
          'День 1 (07:45): Встреча группы. Переезд в Переславль-Залесский. Экскурсия — Спасо-Преображенский собор XII века, Горицкий монастырь, Плещеево озеро. Обед. Переезд в Ростов Великий. Экскурсия по Ростовскому Кремлю. Переезд в Ярославль. Размещение в гостинице 3★',
          'День 2: Завтрак. Обзорная экскурсия по Ярославлю — исторический центр (ЮНЕСКО), церковь Ильи Пророка, Спасо-Преображенский монастырь. Переезд в Кострому. Обед. Ипатьевский монастырь, Музей деревянного зодчества. Размещение в Костроме',
          'День 3: Завтрак. Переезд в Суздаль (180 км). Обзорная экскурсия — Суздальский Кремль, Рождественский собор, Спасо-Евфимиев монастырь, концерт колокольных звонов. Обед. Музей деревянного зодчества. Отправление в обратный путь. Прибытие поздним вечером'
        ]
      },
      { 
        days: 4, 
        price: 20500, 
        description: 'Полный + Владимир',
        cities: ['Сергиев Посад', 'Переславль-Залесский', 'Ростов Великий', 'Ярославль', 'Кострома', 'Суздаль', 'Владимир'],
        program: [
          'День 1 (07:30): Встреча группы. Переезд в Сергиев Посад (70 км). Экскурсия по Троице-Сергиевой Лавре — главный монастырь России, Троицкий собор с мощами преподобного Сергия Радонежского. Обед. Переезд в Переславль-Залесский. Экскурсия. Переезд в Ростов Великий. Размещение',
          'День 2: Завтрак. Экскурсия по Ростовскому Кремлю. Переезд в Ярославль. Обзорная экскурсия — исторический центр, церковь Ильи Пророка, Спасо-Преображенский монастырь. Обед. Размещение в Ярославле',
          'День 3: Завтрак. Переезд в Кострому. Экскурсия — Ипатьевский монастырь, Музей деревянного зодчества. Обед. Переезд в Суздаль. Экскурсия по Суздальскому Кремлю, Спасо-Евфимиев монастырь. Размещение',
          'День 4: Завтрак. Музей деревянного зодчества. Переезд во Владимир (40 км). Обед. Экскурсия — Золотые ворота, Успенский собор с фресками Андрея Рублева, Дмитриевский собор. Отправление в обратный путь. Прибытие поздним вечером'
        ]
      }
    ]
  },

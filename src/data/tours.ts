...
export const tours: Record<string, Tour> = {
  ...
  'bus-tour': {
    ...
    program: [
      'День 1: Встреча группы. Сергиев Посад — посещение Троице-Сергиевой Лавры. Переезд в Ярославль',
      ...
      'День 5: Владимир — Золотые ворота, Успенский собор, Дмитриевский собор. Завершение тура'
    ],
    included: [

...
export const tours: Record<string, Tour> = {
  ...
  'vladimir-principality': {
    ...
    options: [
      { days: 2, price: 10990, description: 'Классический (Суздаль + Владимир + Боголюбово)' },
      { days: 3, price: 15800, description: 'Расширенный + Гусь-Хрустальный' },
      { days: 4, price: 19500, description: 'Максимальный + Муром' }
    ]
  },
  'oka-to-volga': {
    id: 'oka-to-volga',
    ...
    options: [
      { days: 2, price: 16500, description: 'Короткий: Коломна + Рязань' },
      { days: 3, price: 20390, description: 'Классический (весь маршрут)' },
      { days: 4, price: 25800, description: 'Расширенный + Касимов' },
      { days: 5, price: 31200, description: 'Полный + Городец + круиз по Волге' }
    ]
  },
  'holy-rus': {
    id: 'holy-rus',
    ...
    options: [
      { days: 2, price: 11100, description: 'Классический (Муром + Дивеево)' },
      { days: 3, price: 16900, description: 'Расширенный + Арзамас (храмы XVII века)' },
      { days: 4, price: 21500, description: 'Полный + Саров (с разрешением ФСБ)' }
    ]
  }
};
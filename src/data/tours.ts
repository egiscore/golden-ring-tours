...
export const tours: Record<string, Tour> = {
  ...
  'bus-tour': {
    ...
    description: 'Популярные маршруты от туроператора «Русь»',
    fullDescription: 'Выберите один из самых популярных автобусных туров по Золотому кольцу от туроператора «Русь». Комфортабельные автобусы, профессиональные гиды и насыщенные программы позволят увидеть лучшие достопримечательности древних русских городов без забот о логистике.',
    price: 'от 10 990 ₽',
    duration: '2-3 дня',
    icon: 'Bus',
    ...
    program: [
      'Программы туров подобраны туроператором «Русь» — одним из лидеров автобусных туров по Золотому кольцу',

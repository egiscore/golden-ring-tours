...
const faqs = [
  {
    ...
    a: "В стоимость включено ВСЁ: комфортабельный автомобиль с водителем, проживание в хороших отелях, персональный гид-эксперт, все трансферы, входные билеты, полная страховка. Никаких скрытых платежей!",
  },
  {
  ...
  {
    q: "Какие у вас преимущества?",
    a: "Мы даём полностью индивидуальную программу, комфортный транспорт, личного гида-эксперта только для вас, хорошие отели и полный сервис. Вы платите за качество и индивидуальный подход.",
  },
];

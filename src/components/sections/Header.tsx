      ...
      <nav className="container mx-auto px-3 sm:px-6 py-3 sm:py-4 flex justify-between items-center gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <a
              href={`https://wa.me/79255693984?text=${encodeURIComponent('Здравствуйте! Хочу узнать подробнее о ваших турах')}`}
              target="_blank"
            ...
            <a
              href={`tg://msg?to=79255693984&text=${encodeURIComponent('Здравствуйте! Хочу узнать подробнее о ваших турах')}`}
